...
export default function MindTree({ children, className = "", dark = true, height = undefined, connectorStartRatio = 0.8, connectorMinDx = 28 }) {
        ...
        <span className="inline-flex items-center gap-1 relative">
          {depth >= 1 && (
            <span
              ...
              className="text-feather select-none text-2xl leading-none inline-flex items-center font-ascii"
              aria-hidden
            >
              •
            </span>
          ...
          <div
            ...
            className="mind-label inline-block text-primary dark:text-white text-base [&_*]:text-base"
          >
            <button
              type="button"
          ...
          {hasChildren && (
            ...
            type="button"
            className="px-0.5 text-feather hover:text-feather text-2xl leading-none inline-flex items-center justify-center relative -top-0.5 font-ascii"
  ...
  return (
    <div
      ref={outerRef}
      className={`mindtree relative ${theme} ${className} my-4 overflow-auto rounded-2xl border border-feather/10 bg-[#d0d0d0] dark:bg-black ${sizeClass}`}
