...
import team from "../assets/BlackSun.webp"
...
const About = () => {
  ...
  const projectItems = useMemo(() => ([
    {
      title: "BlackSun",
      description: t?.aboutPage?.projectCards?.descriptions?.blackSun || "Dashboard interactivo de muestra.",
      tecnologies: "Next.js, Tailwind.css",
      access: "https://black-sun-project.vercel.app/",
      icon: "custom:blacksun",
    },
    {
      title: "Hornero",
      description: t?.aboutPage?.projectCards?.descriptions?.hornero || "Servicio de desarrollo web para tu negocio.",
    ...
    {
      title: "0SC1 blog",
      description: t?.aboutPage?.projectCards?.descriptions?.osci || "Newsletter y documentación.",
      tecnologies: "React.js, Markdown, Tailwind.css",
      link: "/blog",
      icon: "custom:osci",
    },
        ...
        <section>
          <div className="flex flex-col md:flex-row items-center md:items-start gap-8 mb-16 pt-32">
            ...
            <div className={`flex flex-col items-center gap-4 transition-opacity duration-500 ${showWhoamiContent ? "opacity-100" : "opacity-0"}`}>
              ...
              >
                <h3 className="text-xl font-sans font-semibold mb-4 tracking-wide text-center">{t?.contact|| 'Contacto'}</h3>
            ...
            <div className={`transition-opacity duration-500 ${sections.experience.showContent ? "opacity-100" : "opacity-0"}`}>
              <div className={`p-6 rounded-xl border-2 ${isDark ? "border-primary/10 bg-primary" : "border-secondary/10 bg-secondary"
                ...
                <div className="space-y-4 font-sans text-xl">
                  ...
                  <div className="pt-6">
                    <a href="https://www.mendoza.gov.ar/prensa/un-equipo-mendocino-entre-los-10-ganadores-a-nivel-nacional-del-rally-latinoamericano-de-innovacion-2024/">
                      <img src={team} alt="BlackSun" className="w-full h-auto rounded-xl"/>
                    </a>
                  </div>
                  <p>{t?.aboutPage?.experience?.paragraphs?.[1] || 'Nota de la competencia'}</p>
                </div>
              </div>
            </div>
            <button
